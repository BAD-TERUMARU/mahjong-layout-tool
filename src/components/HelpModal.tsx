        ...
        <div className="help-content">
          ...
          <section className="help-section" id="help-insert">
            ...
            <div className="help-feature-list">
              ...
              <div><strong>図形・線・手書き</strong><span>長方形、三角形、丸、バツ、牌5枚分の波線、直線、曲線、矢印、手書き線を連続配置できます。線は既存の牌や線の上からでも描けます。曲線は、まず始点から終点までドラッグし、次にふくらませたい位置をクリックして確定します。図形を選択し、外枠のハンドルをドラッグするとサイズを変えられます。</span></div>
