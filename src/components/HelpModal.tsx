        ...
        <div className="help-content">
          ...
          <section className="help-section" id="help-insert">
            ...
            <div className="help-feature-list">
              ...
              <div><strong>図形・線・手書き</strong><span>長方形、三角形、丸、バツ、直線、曲線、矢印、手書き線を連続配置できます。曲線は、描きたい弧をそのままなぞってください。最もふくらませた位置を頂点にして曲線になります。図形を選択し、外枠のハンドルをドラッグするとサイズを変えられます。</span></div>
