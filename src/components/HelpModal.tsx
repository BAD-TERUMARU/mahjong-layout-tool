        ...
        <div className="help-content">
          <section className="help-section" id="help-start">
            ...
            <div className="help-steps">
              <div><b>1</b><p><strong>牌一覧から選ぶ</strong><span>左側の牌をクリックすると、空いている自動配置位置に追加されます。牌をそのままワークスペースへドラッグして、好きな場所に置くこともできます。</span></p></div>
              <div><b>2</b><p><strong>連続して配置する</strong><span>自動配置は最初の位置を基準に、一定の間隔で並びます。移動済みの牌があっても、空いている位置を探して重なりを避けます。</span></p></div>
          ...
          <section className="help-section" id="help-insert">
            ...
            <div className="help-feature-list">
              ...
              <div><strong>図形・直線・手書き</strong><span>長方形、三角形、丸、バツ、直線、手書き線を連続配置できます。図形を選択し、外枠のハンドルをドラッグするとサイズを変えられます。</span></div>
          ...
          <section className="help-section" id="help-save">
            ...
            <div className="help-steps compact">
              ...
              <div><b>2</b><p><strong>あとから開く</strong><span>「保存ページ」では、保存済みレイアウトの読み込み、タイトル変更、削除ができます。データはこのブラウザに保存されます。</span></p></div>
              <div><b>3</b><p><strong>共有する</strong><span>保存ページの「共有」から、現在のレイアウトを含むリンクを作成して渡せます。受け取った人はリンクを開いて内容を確認できます。</span></p></div>
            </div>
          </section>
